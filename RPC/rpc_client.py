...
class FibonacciRpcClient(object):
    """docstring for FibonacciRpcClient"""
    def __init__(self):
        super(FibonacciRpcClient, self).__init__()
        self.connection=pika.BlockingConnection(pika.ConnectionParameters(host=secret.ipaddress))
